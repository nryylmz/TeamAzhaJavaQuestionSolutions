...
public class DivisibleBy3_5_15 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 100; i++) {/* created a loop to print the numbers 1 through 100 with a post-increment
                                ...
                                /*created a multi-if statement to check for numbers that are divisible by 15, 5, and 3*/
            if (i % 15 == 0) {
        ...
        System.out.println("Divisible By 15: " + divisibleBy15);
                                                                /* concatenated the 'sections' with the variables that
                                                                   now have values stored in them */
